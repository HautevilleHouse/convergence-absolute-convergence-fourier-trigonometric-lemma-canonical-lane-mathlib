import HautevilleHouse.ConvergenceAbsoluteConvergenceFourierTrigonometricLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "Convergence/Absolute-Convergence Fourier Trigonometric Lemma: All Dirichlet and Fejér kernels satisfy the absolute convergence bridge via the L¹-norm criterion."
